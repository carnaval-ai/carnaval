...
Usage :
    ...
    python anonymize.py doc.txt --profile acknowledge --private mon_profil
    python anonymize.py doc.txt --no-gliner
...
# Permettre l'execution sans installation : ajout src/ au path
_REPO_ROOT = Path(__file__).resolve().parent
sys.path.insert(0, str(_REPO_ROOT / "src"))

from dotenv import load_dotenv  # noqa: E402

from carnaval.core.logger import configure_logging  # noqa: E402
from carnaval.pipeline import run_anonymization  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument(
        "--outbox", type=Path, default=_REPO_ROOT / "outbox",
    ...
    parser.add_argument(
        "--gliner-threshold", type=float, default=0.4,
        help="Seuil de confiance GLiNER (defaut : 0.4)",
    )
    parser.add_argument(
        "--cleanup-pipes", action="store_true",
